								...
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										<li class="breadcrumb-item">
											<a href="table-pu.php">Data Pekerjaan Umum</a>
										</li>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id_opd = "Dinas Pekerjaan Umum"; // Ganti dengan nilai ID OPD yang sesuai
    $id_tahun = $_POST['tahun'];

    // Prepared statement untuk menambahkan data
    $stmt = $connection->prepare("INSERT INTO dispu_flyover_underpass (id_flyover, nama_flyover, ukuran_flyover, kondisi_flyover, tahun_pembuatan, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssss", $id_flyover, $nama_flyover, $ukuran_flyover, $kondisi_flyover, $tahun_pembuatan, $id_opd, $id_tahun);
    $result = $stmt->execute();
...
<form method="POST" action="">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-10">
            <input type="text" name="nama_flyover" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-12 col-md-2 col-form-label">Ukuran Flyover</label>
        <div class="col-sm-12 col-md-10">
            <input type="text" name="ukuran_flyover" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-12 col-md-2 col-form-label">Kondisi Flyover</label>
        <div class="col-sm-12 col-md-10">
            <input type="text" name="kondisi_flyover" class="form-control">
        </div>
    </div>
    <div class="form-group row">
