								...
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										<li class="breadcrumb-item">
											<a href="table-kesehatan.php">Dinas Kesahatan</a>
										</li>
						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              <?php
                                   ...
                                   $stmt = $connection->prepare("INSERT INTO rumah_sakit (id_rs, nama_rs, rs_umum, rs_kusus, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?)");
                                   $stmt->bind_param("ssssss", $id_sarana, $sarana, $rawat_inap, $non_rawat_inap, $opd, $tahun);
                                   $result = $stmt->execute();
                              ...
                              <form method="POST" action="">
                                   ...
                                   <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                             <input type="text" name="rawat_inap" class="form-control">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">Rumah Sakit Khusus</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="text" name="non_rawat_inap" class="form-control">
                                        </div>
                                   </div>
