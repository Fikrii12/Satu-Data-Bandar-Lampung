							...
							<div class="pull-left">
                              ...
                              <?php
                                   ...
                                   if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        ...
                                        $stmt = $connection->prepare("INSERT INTO dukcapil_jenis_kelamin (id_kecamatan, kecamatan, pria, wanita, jumlah, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?)");
                             ...
                             <!-- Form untuk menambahkan data -->
                              ...
                              <div class="form-group row">
                                   ...
                                   <div class="col-sm-12 col-md-10">
                                        <input type="number" name="pria" class="form-control">
                                   </div>
                              </div>
                              <div class="form-group row">
