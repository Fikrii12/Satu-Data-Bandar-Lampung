						...
						<div class="clearfix">
                         ...
                         <?php
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                   ...
                                   $query = "UPDATE tenaga_kerja SET tenaga_kerja = '$tenaga_kerja', jumlah = '$jumlah' WHERE id_tenaga = '$id'";
                              ...
                              $query = "SELECT * FROM tenaga_kerja WHERE id_tenaga = '$id'";
                              $result = $connection->query($query);
                         ...
                         <div class="form-group row">
                              <label class="col-sm-12 col-md-2 col-form-label">Tenaga Kerja</label>
                              <div class="col-sm-12 col-md-10">
                                   <input type="text" name="tenaga_kerja" value="<?php echo $row['tenaga_kerja']; ?>" class="form-control">
                              </div>
                         </div>
                         <div class="form-group row">
