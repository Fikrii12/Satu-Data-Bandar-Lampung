				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						$opd = "Dinas Pangan";
                              ...
                              $stmt = $connection->prepare("INSERT INTO dispan (id_komoditas, komoditas, total, kebutuhan, stok_akhir, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?)");
                              $stmt->bind_param("sssssss", $id_komoditas, $komoditas, $total, $kebutuhan, $stok_akhir, $opd, $tahun);
                              $result = $stmt->execute();
                              ...
                              <form method="POST" action="">
                                   ...
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">Kebutuhan Untuk Ramadhan</label>
                                        <div class="col-sm-12 col-md-10">
