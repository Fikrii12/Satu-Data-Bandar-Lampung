				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						$opd = "BKD";
                              ...
                              $stmt = $connection->prepare("INSERT INTO bkd_umur (id_umur, umur, pria, wanita, jumlah, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?)");
                              $stmt->bind_param("sssssss", $id_umur, $umur, $jumlah_pria, $jumlah_wanita, $jumlah_total, $opd, $tahun);
                              $result = $stmt->execute();
