						...
						<?php
                                   ...
                                   if ($handle) {
                                        ...
                                        while (($data = fgetcsv($handle, 1000, ";")) !== false) {
                                             ...
                                             // Modify the following section to match the columns of ducapil_umur table.
                                             if (count($data) === 9) {
                                                  $id_kecamatan = uniqid();
                                                  ...
                                                  $stmt = $conn->prepare("INSERT INTO ducapil_umur (id_kecamatan, kecamatan, umur1, umur2, umur3, umur4, umur5, umur6, umur7, umur8, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                                                  $stmt->bind_param("ssiiiiiiiiii", $id_kecamatan, $kecamatan, $umur1, $umur2, $umur3, $umur4, $umur5, $umur6, $umur7, $umur8, $opd, $tahun);
                                                  $result = $stmt->execute();
                                             }
                                        }
