						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                   ...
                                   // Prepared statement untuk memperbarui data
                                   $stmt = $connection->prepare("UPDATE dishub_wajib_biaya SET bulan = ?, jumlah = ?, biaya = ? WHERE id_bulan = ?");
                                   $stmt->bind_param("ssss", $bulan, $jumlah, $biaya, $id);
                                   $result = $stmt->execute();
                              ...
                              $stmt = $connection->prepare("SELECT bulan, jumlah, biaya FROM dishub_wajib_biaya WHERE id_bulan = ?");
                              ...
                              ?>
                                   <form method="POST" action="">
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-12 col-md-10">
                                                  <input type="number" name="biaya" value="<?php echo $row['biaya']; ?>" class="form-control">
                                             </div>
                                        </div>
                              ...
                              echo "Data bulan tidak ditemukan.";
                              }
