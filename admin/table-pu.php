<!DOCTYPE html>
	<html>
		<head>
			<!-- Basic Page Info -->
			<meta charset="utf-8" />
			<title>Data Dinas Pekerjaan Umum</title>
						...
						<div class="page-header">
							<div class="row">
                              ...
                              <div class="d-flex align-items-center">
                                   <h2 class="h4 pd-20">Jumlah Pembangunan Fly Over dan Under Pass</h2>
                                   <div class="justify-content-between float-right">
                                        <a href="input-data-flyover-underpass.php" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> Impor Data</a>
                                        <a href="tambah-flyover-underpass.php" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
                                        <a href="hapus-data-flyover-underpass.php" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus Data</a>
                                   </div>
                              </div>
                              ...
                              function getDataByYear() {
                                   ...
                                   var xhttpFlyoverUnderpass = new XMLHttpRequest();

                                   xhttpFlyoverUnderpass.onreadystatechange = function() {
                                        if (this.readyState == 4 && this.status == 200) {
                                             document.getElementById('data-table-flyover-underpass').innerHTML = this.responseText;
                                        }
                                   };

                                   xhttpFlyoverUnderpass.open("GET", "tahun_flyover_underpass.php?year=" + selectedYear, true);
                                   xhttpFlyoverUnderpass.send();
