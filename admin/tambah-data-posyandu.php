						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              <?php
                                   ...
                                   $stmt = $connection->prepare("INSERT INTO posyandu (id_posyandu, kecamatan, puskesmas, pratama, madya, purnama, mandiri, jumlah, aktif, puskeskel, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
