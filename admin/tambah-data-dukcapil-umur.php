						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              <?php
                                   ...
                                   $stmt = $connection->prepare("INSERT INTO ducapil_umur (id_kecamatan, kecamatan, umur1, umur2, umur3, umur4, umur5, umur6, umur7, umur8, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                                   $stmt->bind_param("ssssssssssss", $id_kecamatan, $kecamatan, $umur1, $umur2, $umur3, $umur4, $umur5, $umur6, $umur7, $umur8, $opd, $tahun);
                                   $result = $stmt->execute();
                                   ...
                                   <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="umur1" class="form-control">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">10-19</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="umur2" class="form-control">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">20-29</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="umur3" class="form-control">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">30-39</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="umur4" class="form-control">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">40-49</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="umur5" class="form-control">
                                        </div>
                                   </div>
                                   <!-- Add more age group input fields here as needed -->
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">50-59</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="umur6" class="form-control">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">60-69</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="umur7" class="form-control">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">>70</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="umur8" class="form-control">
                                        </div>
                                   </div>
