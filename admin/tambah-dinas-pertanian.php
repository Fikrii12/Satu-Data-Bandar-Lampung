				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						$opd = "Dinas Pertanian";
                              ...
                              $stmt = $connection->prepare("INSERT INTO dispentani (id_tanaman, nama_tanaman, luas_tanaman, luas_rusak, luas_penanaman, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?)");
                              $stmt->bind_param("sssssss", $id_tanaman, $nama_tanaman, $luas_tanaman, $luas_rusak, $luas_penanaman, $opd, $tahun);
                              $result = $stmt->execute();
                              ...
                              <form method="POST" action="">
                                   ...
                                   <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="luas_tanaman" class="form-control" step="any">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">Luas Rusak (Ha)</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="luas_rusak" class="form-control" step="any">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">Luas Penanaman (Ha)</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="luas_penanaman" class="form-control" step="any">
                                        </div>
                                   </div>
