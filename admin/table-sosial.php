							...
							<div class="row">
                              ...
                              <div class="card-box pb-10 mt-5">
                                   <div class="d-flex align-items-center">
                                        <h2 class="h4 pd-20">Data Dinsos</h2>
                                        <div class="justify-content-between float-right">
                                             <a href="input-data-dinsos.php" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> Impor Data</a>
                                             <a href="tambah-dinsos.php" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
                                             <a href="hapus-tahun-dinsos.php" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus Data</a>
                                        </div>
                                   </div>
                              ...
                              <script>
                                   function getDataByYear() {
                                        ...
                                        var xhttpDinsos = new XMLHttpRequest();

                                        xhttpDinsos.onreadystatechange = function() {
                                             if (this.readyState == 4 && this.status == 200) {
                                                  document.getElementById('data-table-dinsos').innerHTML = this.responseText;
                                             }
                                        };

                                        xhttpDinsos.open("GET", "tahun_dinsos.php?year=" + selectedYear, true);
                                        xhttpDinsos.send();
