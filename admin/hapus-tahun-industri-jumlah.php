			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">Hapus Data Pertahun </h4>
							</div>
						...
						require_once 'database.php';
                              ...
                              $query = "DELETE FROM industri_jumlah WHERE id_tahun = '$tahun'";
                              ...
                              <form method="POST" action="">
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">Pilih Tahun</label>
