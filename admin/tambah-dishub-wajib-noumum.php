				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						$opd = "Dinas Perhubungan";
                              ...
                              $stmt = $connection->prepare("INSERT INTO dishub_wajib_noumum (id_kendaraan, jenis, jumlah, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?)");
                              $stmt->bind_param("sssss", $id_kendaraan, $jenis, $jumlah, $opd, $tahun);
                              $result = $stmt->execute();
