			...
			<div class="pd-20 card-box mb-30">
				...
				if (isset($_GET['id'])) {
					...
					if ($_SERVER["REQUEST_METHOD"] == "POST") {
						...
						$query = "UPDATE bkd_umur SET umur= '$umur', pria= '$pria', wanita = '$wanita', jumlah = '$jumlah' WHERE id_umur = '$id'";
					...
					$query = "SELECT * FROM bkd_umur WHERE id_umur = '$id'";
					$result = $connection->query($query);
				...
				?>
						<form method="POST" action="">
							...
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Kelompok Umur</label>
								<div class="col-sm-12 col-md-10">
									<input type="text" name="umur" value="<?php echo $row['umur']; ?>" class="form-control">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">jumlah Pria</label>
								<div class="col-sm-12 col-md-10">
									<input type="number" name="pria" value="<?php echo $row['pria']; ?>" class="form-control" step="any">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">Jumlah Wanita</label>
								<div class="col-sm-12 col-md-10">
									<input type="number" name="wanita" value="<?php echo $row['wanita']; ?>" class="form-control" step="any">
								</div>
							</div>
							<div class="form-group row">
