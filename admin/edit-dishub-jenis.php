				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						if ($_SERVER["REQUEST_METHOD"] == "POST") {
							$id = $_POST['id'];
							$bulan = $_POST['bulan'];
							$truck_pick_up = $_POST['truck_pick_up'];
							$bus = $_POST['bus'];
							$oplet= $_POST['oplet'];
							// Query untuk memperbarui data
							$query = "UPDATE dishub SET  truck_pick_up = '$truck_pick_up', bus = '$bus', oplet = '$oplet' WHERE id_bulan = '$id'";
						...
						$query = "SELECT * FROM dishub WHERE id_bulan = '$id'";
						$result = $connection->query($query);
							...
							<form method="POST" action="">
								...
								<div class="form-group row">
									...
									<div class="col-sm-12 col-md-10">
										<input type="text" name="bulan" value="<?php echo $row['bulan']; ?>" class="form-control" readonly>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-12 col-md-2 col-form-label">Jumlah Tuck/Pick-Up</label>
									<div class="col-sm-12 col-md-10">
										<input type="number" name="truck_pick_up" value="<?php echo $row['truck_pick_up']; ?>" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-12 col-md-2 col-form-label">Jumlah Bus</label>
									<div class="col-sm-12 col-md-10">
										<input type="number" name="bus" value="<?php echo $row['bus']; ?>" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-12 col-md-2 col-form-label">Jumlah Oplet</label>
									<div class="col-sm-12 col-md-10">
										<input type="number" name="oplet" value="<?php echo $row['oplet']; ?>" class="form-control">
									</div>
								</div>
