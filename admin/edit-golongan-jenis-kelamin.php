				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						if ($_SERVER["REQUEST_METHOD"] == "POST") {
							...
							$query = "UPDATE bkd_golongan_jenis_kelamin SET golongan = '$golongan', pria = '$jumlah_pria', wanita = '$jumlah_wanita', jumlah = '$jumlah_total' WHERE id_golongan_jenis_kelamin = '$id'";
						...
						$query = "SELECT * FROM bkd_golongan_jenis_kelamin WHERE id_golongan_jenis_kelamin = '$id'";
						$result = $connection->query($query);
