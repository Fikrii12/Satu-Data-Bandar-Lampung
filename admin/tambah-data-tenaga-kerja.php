						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              <?php
                                   ...
                                   $stmt = $connection->prepare("INSERT INTO tenaga_kerja (id_tenaga, tenaga_kerja, jumlah, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?)");
                                   $stmt->bind_param("sssss", $id_tenaga, $tenaga_kerja, $jumlah, $opd, $tahun);
                                   $result = $stmt->execute();
