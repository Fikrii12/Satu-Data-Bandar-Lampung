					...
					<div class="pd-20 card-box mb-30">
						...
						<?php
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                   ...
                                   $non_rawat_inap = $_POST['non_rawat_inap'];

                                   // Query untuk memperbarui data
                                   $query = "UPDATE puskesmas SET sarana = '$sarana', rawat_inap = '$rawat_inap', non_rawat_inap = '$non_rawat_inap' WHERE id_sarana = '$id'";
                              ...
                              $query = "SELECT * FROM puskesmas WHERE id_sarana = '$id'";
                              $result = $connection->query($query);
                              ...
                              ?>
                                   <form method="POST" action="">
                                        ...
                                        <div class="form-group row">
                                             <label class="col-sm-12 col-md-2 col-form-label">Sarana</label>
                                             <div class="col-sm-12 col-md-10">
                                                  <input type="text" name="sarana" value="<?php echo $row['sarana']; ?>" class="form-control">
                                             </div>
                                        </div>
                                        <div class="form-group row">
                                             <label class="col-sm-12 col-md-2 col-form-label">Rawat Inap</label>
                                             <div class="col-sm-12 col-md-10">
                                                  <input type="text" name="rawat_inap" value="<?php echo $row['rawat_inap']; ?>" class="form-control">
                                             </div>
                                        </div>
                                        <div class="form-group row">
                                             <label class="col-sm-12 col-md-2 col-form-label">Non Rawat Inap</label>
                                             <div class="col-sm-12 col-md-10">
                                                  <input type="text" name="non_rawat_inap" value="<?php echo $row['non_rawat_inap']; ?>" class="form-control">
                                             </div>
                                        </div>
