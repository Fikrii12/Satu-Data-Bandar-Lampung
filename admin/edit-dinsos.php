               ...
               <div class="min-height-200px">
                    ...
                    <div class="pd-20 card-box mb-30">
                         ...
                         if (isset($_GET['id'])) {
                              ...
                              $query = "UPDATE dinsos SET kecamatan = '$kecamatan', jumlah_individu = $jumlah_individu, jumlah_keluarga = $jumlah_keluarga WHERE id_kecamatan = '$id'";
                              ...
                              // Query untuk mendapatkan data berdasarkan id kecamatan sebelum diperbarui
                              $query = "SELECT * FROM dinsos WHERE id_kecamatan = '$id'";
                              $result = $connection->query($query);
                         ...
                         ?>
                              <form method="POST" action="">
                                   ...
                                   <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="jumlah_individu" value="<?php echo $row['jumlah_individu']; ?>" class="form-control">
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">Jumlah Keluarga</label>
                                        <div class="col-sm-12 col-md-10">
                                             <input type="number" name="jumlah_keluarga" value="<?php echo $row['jumlah_keluarga']; ?>" class="form-control">
                                        </div>
                                   </div>
                         ...
                         <?php
                              ...
                              echo "ID kecamatan tidak ditemukan.";
                         }
