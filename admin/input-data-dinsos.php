						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              if ($handle) {
                                   ...
                                   $opd = "Dinas Sosial"; // Nilai dari opd
                                   ...
                                   while (($data = fgetcsv($handle, 1000, ";")) !== false) {
                                        ...
                                        if (count($data) === 3) {
                                             ...
                                             $jumlahIndividu = (int)$conn->real_escape_string($data[1]);
                                             $jumlahKeluarga = (int)$conn->real_escape_string($data[2]);
                     

                                             // Query untuk menyimpan data ke dalam tabel

                                             $stmt = $conn->prepare("INSERT INTO dinsos (id_kecamatan, kecamatan, jumlah_individu, jumlah_keluarga, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?)");
                                             $stmt->bind_param("sssisi", $uniqueId, $kecamatan, $jumlahIndividu, $jumlahKeluarga, $opd, $tahun);
                                             $result = $stmt->execute();
