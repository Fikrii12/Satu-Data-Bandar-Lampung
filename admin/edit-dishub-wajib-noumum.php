						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                   ...
                                   $query = "UPDATE dishub_wajib_noumum SET jenis = '$jenis', jumlah = '$jumlah' WHERE id_kendaraan = '$id'";
                              ...
                              $query = "SELECT * FROM dishub_wajib_noumum WHERE id_kendaraan = '$id'";
                              $result = $connection->query($query);
                              ...
                              ?>
                                   <form method="POST" action="">
                                        ...
                                        <div class="form-group row">
                                             <label class="col-sm-12 col-md-2 col-form-label">Jenis Kendaraan</label>
