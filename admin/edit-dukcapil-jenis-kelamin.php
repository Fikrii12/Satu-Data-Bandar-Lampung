						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                   ...
                                   $stmt = $connection->prepare("UPDATE dukcapil_jenis_kelamin SET kecamatan = ?, pria = ?, wanita = ?, jumlah = ? WHERE id_kecamatan = ?");
                                   $stmt->bind_param("siiis", $kecamatan, $pria, $wanita, $jumlah, $id);
                                   $result = $stmt->execute();
                              ...
                              $stmt = $connection->prepare("SELECT * FROM dukcapil_jenis_kelamin WHERE id_kecamatan = ?");
