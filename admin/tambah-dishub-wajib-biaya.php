					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              $stmt = $connection->prepare("INSERT INTO dishub_wajib_biaya (id_bulan, bulan, jumlah, biaya, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?)");
                              $stmt->bind_param("ssddss", $id_bulan, $bulan, $jumlah, $biaya, $opd, $tahun);
                              $result = $stmt->execute();
