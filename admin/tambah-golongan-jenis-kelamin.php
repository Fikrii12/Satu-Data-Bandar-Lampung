				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						$opd = "BKD";
                              ...
                              $jumlah_total = $jumlah_pria+$jumlah_wanita;

                              // Prepared statement untuk menambahkan data
                              $stmt = $connection->prepare("INSERT INTO bkd_golongan_jenis_kelamin (id_golongan_jenis_kelamin, golongan, pria, wanita, jumlah, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?)");
                              $stmt->bind_param("sssssss", $id_golongan, $golongan, $jumlah_pria, $jumlah_wanita, $jumlah_total, $opd, $tahun);
                              $result = $stmt->execute();
