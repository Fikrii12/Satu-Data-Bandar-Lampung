				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						...
						$opd = "Dinas Perhubungan";
                              ...
                              $stmt = $connection->prepare("INSERT INTO dishub (id_bulan, bulan, truck_pick_up, bus, oplet, id_opd, id_tahun) VALUES (?, ?, ?, ?, ?, ?, ?)");
                              $stmt->bind_param("sssssss", $id_bulan, $bulan, $truck_pick_up, $bus, $oplet, $opd, $tahun);
                              $result = $stmt->execute();
                              ...
                              <div class="form-group row">
                                   <label class="col-sm-12 col-md-2 col-form-label">Jumlah Truck/Pick-Up</label>
                                   <div class="col-sm-12 col-md-10">
                                        <input type="number" name="truck_pick_up" class="form-control">
                                   </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                   ...
                                   <div class="col-sm-12 col-md-10">
                                        <input type="number" name="oplet" class="form-control">
                                   </div>
                              </div>
