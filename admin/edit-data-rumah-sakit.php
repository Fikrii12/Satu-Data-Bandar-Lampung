						...
						<div class="clearfix">
							<div class="pull-left">
                              ...
                              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                   ...
                                   $query = "UPDATE rumah_sakit SET nama_rs = '$sarana', rs_umum = '$rawat_inap', rs_kusus = '$non_rawat_inap' WHERE id_rs = '$id'";
                              ...
                              $query = "SELECT * FROM rumah_sakit WHERE id_rs = '$id'";
                              $result = $connection->query($query);
                              ...
                              ?>
                                   <form method="POST" action="">
                                        ...
                                        <div class="form-group row">
                                             <label class="col-sm-12 col-md-2 col-form-label">Nama Rumah Sakit</label>
                                             <div class="col-sm-12 col-md-10">
                                                  <input type="text" name="sarana" value="<?php echo $row['nama_rs']; ?>" class="form-control">
                                             </div>
                                        </div>
                                        <div class="form-group row">
                                             <label class="col-sm-12 col-md-2 col-form-label">Rumah Sakit Umum</label>
                                             <div class="col-sm-12 col-md-10">
                                                  <input type="text" name="rawat_inap" value="<?php echo $row['rs_umum']; ?>" class="form-control">
                                             </div>
                                        </div>
                                        <div class="form-group row">
                                             <label class="col-sm-12 col-md-2 col-form-label">Rumah Sakit Khusus</label>
                                             <div class="col-sm-12 col-md-10">
                                                  <input type="text" name="non_rawat_inap" value="<?php echo $row['rs_kusus']; ?>" class="form-control">
                                             </div>
                                        </div>
